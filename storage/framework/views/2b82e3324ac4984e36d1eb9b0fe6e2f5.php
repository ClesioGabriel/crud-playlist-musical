<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__("Atualize as informações do perfil e o endereço de e-mail da sua conta.")); ?>
            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 text-gray-800 dark:text-gray-200">
                        <?php echo e(__('Seu endereço de e-mail não foi verificado.')); ?>
...
</section><?php /**PATH /var/www/resources/views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>