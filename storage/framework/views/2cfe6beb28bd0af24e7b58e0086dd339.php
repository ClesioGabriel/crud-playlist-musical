<?php $__env->startSection('title', 'Detalhes da Música'); ?>
...
<?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('is-admin')): ?>
            <form action="<?php echo e(route('musics.destroy', $music->id)); ?>" method="POST" onsubmit="return confirm('Tem certeza que deseja deletar?')">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.users.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/musics/show.blade.php ENDPATH**/ ?>