...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Permanecer conectado')); ?></span>
            </label>
        </div>

        <!-- Register Link -->
        <div class="mt-4">
            <a href="<?php echo e(route('register')); ?>" class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
...
<?php endif; ?>
<?php /**PATH /home/clesio/project1/laravel-10/resources/views/auth/login.blade.php ENDPATH**/ ?>