<?php $__env->startSection('title', 'Detalhes do Artista'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="py-4">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 max-w-md mb-4">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-4">
                Detalhes do Artista: <?php echo e($artist->name); ?>

            </h2>

            <ul class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300">
                <li><strong>Nome:</strong> <?php echo e($artist->name); ?></li>
    ...
    <div>
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 mb-4">
            ...
            <?php if($artist->musics->isEmpty()): ?>
                <p class="text-gray-500 dark:text-gray-400">Nenhuma música cadastrada.</p>
            <?php else: ?>
                <p class="text-gray-500 dark:text-gray-400 mb-4">
                    Total de músicas: <?php echo e($artist->musics->count()); ?>

                </p>

                <ul class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300">
                    <?php $__currentLoopData = $artist->musics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $music): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
...
<?php endif; ?>
    ...
    <div class="flex items-center gap-4 mt-6">
        <a href="<?php echo e(route('artists.index')); ?>">
...
<?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('is-admin')): ?>
            <form action="<?php echo e(route('artists.destroy', $artist->id)); ?>" method="POST" onsubmit="return confirm('Tem certeza que deseja deletar?')">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.users.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/artists/show.blade.php ENDPATH**/ ?>