<?php $__env->startSection('title', 'Detalhes do Álbum'); ?>
    ...
    <div class="py-4">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 max-w-md mb-4">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-4">
                Detalhes do Álbum: <?php echo e($album->name); ?>

            </h2>

            <ul class="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300">
                <li><strong>Título:</strong> <?php echo e($album->name); ?></li>
                <li><strong>Artista:</strong> <?php echo e($album->artist->name ?? 'Artista não encontrado'); ?></li>
                <li><strong>Gênero Musical:</strong> <?php echo e($album->genre); ?></li>
            </ul>
        </div>
    </div>
...
<?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('is-admin')): ?>
            <form action="<?php echo e(route('albums.destroy', $album->id)); ?>" method="POST" onsubmit="return confirm('Tem certeza que deseja deletar?')">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.users.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/albums/show.blade.php ENDPATH**/ ?>