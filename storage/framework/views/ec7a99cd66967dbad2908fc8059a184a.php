...
<div class="">
    ...
    <div class="mb-4">
        <input type="file" name="image" placeholder="Imagem do Artista"
            class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    </div>

    <div class="mb-4">
        <input type="text" name="name" placeholder="Nome" value="<?php echo e($artist->name ?? old('name')); ?>"
            class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    </div>
        ...
        <select name="album_id"
            ...
            <?php $__currentLoopData = $albums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($album->id); ?>"
                    <?php echo e(old('album_id') == $album->id || (isset($artist) && $artist->album_id == $album->id) ? 'selected' : ''); ?>>
    ...
    <div class="mb-4">
        <input type="date" name="birth_date" placeholder="Data de Nascimento" value="<?php echo e($artist->birth_date ?? old('birth_date')); ?>"
            class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    </div>
...
</div><?php /**PATH /var/www/resources/views/artists/partials/form.blade.php ENDPATH**/ ?>